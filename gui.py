...
class App(tk.Tk):
    ...
    def create_widgets(self):
        ...
        ttk.Label(advanced_content, text=LANGUAGES[self.language]['pitch']).grid(row=1, column=0, padx=5, pady=5, sticky='w')
        ...
        ttk.Label(advanced_content, text=LANGUAGES[self.language]['game_version']).grid(row=2, column=0, padx=5, pady=5, sticky='w')
        self.game_version_entry = ttk.Entry(advanced_content, width=20)
        self.game_version_entry.insert(0, '1.20.1')
        self.game_version_entry.grid(row=2, column=1, padx=5, pady=5)
